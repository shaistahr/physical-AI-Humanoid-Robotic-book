    ...
    <>
      ...
      <header style={styles.header}>
        <div style={styles.navbar}>
          <div style={styles.logo}>Shazz Khan</div>
      ...
      <section style={styles.hero}>
        <div style={styles.heroContent}>
          ...
          <div style={{ ...styles.right, animation: "fadeIn 1.2s forwards" }}>
            <p style={styles.badge}>Shazz Khan Book Series</p>
            ...
            <div style={styles.buttons}>
              <a
                href="https://github.com/shaistahr"
                target="_blank"
      ...
      <footer style={styles.footer}>
        <p>© {new Date().getFullYear()} Shazz Khan — All Rights Reserved.</p>
